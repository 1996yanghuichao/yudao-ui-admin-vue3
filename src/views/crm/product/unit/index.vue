    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['crm:product-unit:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['crm:product-unit:export']"
        >
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['crm:product-unit:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['crm:product-unit:delete']"
          >
            删除
          </el-button>
        </template>
...
/** CRM 产品单位 列表 */
defineOptions({ name: 'CrmProductUnit' })
...
const handleExport = async () => {
  try {
    ...
    download.excel(data, 'CRM 产品单位.xls')
  } catch {
  } finally {
